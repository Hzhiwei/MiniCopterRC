...
#define IIC_SCL_L		HAL_GPIO_WritePin(GPIOB, GPIO_PIN_3, GPIO_PIN_RESET)
#define IIC_SCL_H		HAL_GPIO_WritePin(GPIOB, GPIO_PIN_3, GPIO_PIN_SET)
#define IIC_SDA_L		HAL_GPIO_WritePin(GPIOB, GPIO_PIN_5, GPIO_PIN_RESET)
#define IIC_SDA_H		HAL_GPIO_WritePin(GPIOB, GPIO_PIN_5, GPIO_PIN_SET)
#define	IIC_SDA_Read	HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_5)
